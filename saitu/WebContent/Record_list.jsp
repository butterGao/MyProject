...
<script type="text/javascript">
	...
	function cc(){
		document.getElementById("url").value="Record_listByDate";
		document.form1.action="Record_listByDate";
		
	}
</script>
<%@include file="public.jsp" %>
<div align="center" id="Layer1">
	<s:form name="form1"  action="Record_list" theme="simple">
	<div style="display: none">
		...
		<s:textfield name="date1"
					...
					<s:submit onclick="cc()" value="提交"></s:submit>
		</td>
		</tr>
	</table>
	</s:form>
