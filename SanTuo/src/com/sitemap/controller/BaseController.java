...
public abstract class BaseController extends Controller {
	...
	public static String st_qiandao="st_qiandao";
	...
	public void save(){
		try {
			Db.save(tableName,getRecord().remove("oper").set("id", "userSequ.nextval").set("createtime",TimeUtil.getNewDate()));
		} catch (Exception e) {
	...
	public void show() {
		Page<Record>p=Db.paginate(getParaToInt("page"), getParaToInt("rows"), "select *", "from " + tableName+ "order by id desc");
