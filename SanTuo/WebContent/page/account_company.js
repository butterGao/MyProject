$(function(){
		...
		jQuery("#grid-table").jqGrid({
			...
			colNames:[ '公司名称','账号数量','地图区域','开始时间','结束时间','创建时间'],
			colModel:[
				{name:'NAME',index:'NAME', width:60, editable: true,editrules:{required:true}},
				{name:'XMFNUMBER',index:'XMFNUMBER',width:40, editable:true,editrules:{number:true,required:true,minValue:0,integer:true}},
...
//						var rid=$("#grid-table").jqGrid("getGridParam","selrow");
//						var ss=$("#grid-table").jqGrid("getCell",rid,"STARTTIME");
//						var nn=$("#grid-table").jqGrid("getCell",rid,"ENDTIME");
//						$("#STARTTIME").val(ss);
//						$("#ENDTIME").val(nn);
