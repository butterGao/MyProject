$(function(){
		 var grid_selector = "#grid-table";
			...
			var juese="";
			var project="";
			ajaxFunction("au/queryProject",null, function(data){
		...
		jQuery("#grid-table").jqGrid({
			...
			colNames:['用户名','用户登录名','密码','电话','角色','所属项目','所属组','创建时间'],
			colModel:[
				...
				{name:'PID',index:'PID',width:90, editable:true,edittype:"select",editoptions:{value:project},formatter:'select',},
				{name:'GID',index:'GID',width:90, editable:true,edittype:"select",editoptions:{value:zhu},formatter:'select',editrules:{required:true}},
		...
		jQuery(grid_selector).jqGrid('navGrid',pager_selector,
				...
				},
				{
					...
					beforeShowForm : function(e) {
						...
						$("#PID").change(function(){
							ajaxHtmlToSelect('au/zhu',{pid:$("#PID").val()}, "GID");
						});
						ajaxHtmlToSelect('au/zhu',{pid:$("#PID").val()}, "GID");
						var form = $(e[0]);
				...
				},
				{
					...
					beforeSubmit:function(e,id){
						...
						ajaxFunction('/au/isSurPassAccount', null, function(data){
							s=data;
						});
						return [s,'可创建账号达到上限']; 
					}
