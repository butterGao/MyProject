...
<body style="background-color:black;background-image: url('images/2.jpg');"> 
	...
	<div class="panel" style="margin: auto;width: 380px;height: 180px;background-color: white;opacity:0.7" onmouseout="hidenopactiy(this)" onmousemove="showopacity(this)">   
