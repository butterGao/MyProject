...
function inits(id){
	...
	$(document).ready(function(e) {
		$("#EXPERIENCE a:eq(0)").css({
			"color" : "black"
		});
		$("#EXPERIENCE a:eq(1)").css({
			"color" : "white"
		});
	});
	...
	function showList(id,title,p){
		$.ajax({
			   ...
			   success: function(msg){
				   var data=eval('('+msg+')');
			    $("#listtitle").html("经验分享&nbsp;&bull;&nbsp;<b style='color: #000;'>"+title+"</b>");
			    var body="";
			    var cc=data.one.list;
			    if(cc[0]==undefined){
			    	alert("该项暂时没有内容");
	...
	<div id="center">
		...
		<div id="zhongti"
			...
			<div
				...
				<div
					style="border-bottom: 1px #003399 solid; background-color: #069; padding-left: 10px;; color: white;">经验分享</div>
				<div style="border-bottom: 1px #003399 solid; padding-left: 10px;"
					id="p1">
					<a style="text-decoration: none; color: #F36; font-size: 10pt">经验分享</a>
				</div>
				<div style="border-bottom: 1px #003399 solid; padding-left: 10px;"
					id="p2">
					<a style="text-decoration: none; color: #000; font-size: 10pt">故障案例</a>
				</div>
				</div>
			<div
				...
				<div style="width: 100%; height: 24px;">
					<div style="float: right;">
						<div id="listtitle"
							...
							经验分享&nbsp;&bull;&nbsp;<b style="color: #000;">经验分享</b>
						</div>
					</div>
				</div>
